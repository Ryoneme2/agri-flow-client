        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-between item-center">
            <div className="flex justify-center items-baseline ">
              <p className="text-[1.75rem] font-bold text-[#1C658C] m-0 p-0">
                {blogcount}
              </p>
              <p className="pl-2 text-[1rem] font-light truncate m-0 p-0">
                บล็อก
              </p>
            </div>
            <div className="flex justify-center items-baseline">
          ...
          <div className="w-full h-auto flex flex-row justify-between md:items-center  ">
            ...
            {!user || !user?.username || user.username !== data?.username ? (
              <></>
            ) : (
              <div className="flex flex-col">
                ...
                <Button
                  onClick={logout}
                  className="h-[1.875rem] rounded-[10px] hover:bg-red-600 bg-red-500 text-white my-0 md:my-2"
                >
                  ออกจากระบบ
                </Button>
              </div>
          ...
          <div className="h-[6rem] border-b-2 mt-2">
            <textarea
              ...
              className="w-full h-[5rem] resize-none overflow-y-auto focus:outline-none"
            />
          </div>
