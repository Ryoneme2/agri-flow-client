...
const Addcomment = ({postid}) => {
    ...
    const clickComment = async () => {
        try {
            ...
            const res = await axios.post(`${host}/api/v1/blogs/p/comments/`,
                {
                    blogId: postid,
    ...
    return (
        <>
            <div
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-messages"
                        width="30" height="30" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#1C658C" fill="none" strokeLinecap="round" strokeLinejoin="round">
