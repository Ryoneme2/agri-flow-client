            ...
            <div className='w-[98%] h-[15.625rem] flex justify-center items-center'>
                ...
                <div className='w-full h-full ml-2'>
                    ...
                    <div className='w-full'>
                        <div className='h-[5.25rem] w-[90%] overflow-y-hidden '>
                            <p className='text-[#979797] text-[1.188rem] m-0 p-0 font-light'>
                                หากยังนึกไม่ออก ให้ลองจินตนาการภาพเด็กที่ไม่กลัวฝน ไม่กลัวเปียก กลับมองฝน มองการเปียกปอนเป็นเรื่องสนุกสนานด้วยซ้ำไป
                                ...
                                เหล่านี้ มันไม่สำคัญอะไรต่อ “เราในเวอร์ชั่นที่ดีที่สุด” เลย…
                            </p>
                        </div>
                    </div>
                    {/* footer */}
